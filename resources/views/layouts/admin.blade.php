...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <main class="flex-1 p-10 overflow-y-auto">
        <header class="flex justify-between items-center mb-10">
            <div>
                <h1 class="text-3xl font-black">@yield('header_title', 'Dashboard Ringkasan')</h1>
                <p class="text-slate-500 font-medium">@yield('header_subtitle', 'Selamat datang kembali, Admin!')</p>
            </div>
